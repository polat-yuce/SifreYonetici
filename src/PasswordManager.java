...
public class PasswordManager {
        ...
        public static void main(String[] args) {
            // Şifreleri saklamak için bir Map yapısı oluşturuldu.
            ...
            while (true) {
                ...
                scanner.nextLine(); // Yeni satır karakterini tüketmek için (dummy code)
                ...
                switch (choice) {
                    case 1:
                        ...
                        // Şifreyi eklemek için metod çağrıldı.
        ...
        // Yeni bir şifre eklemek için kullanılan metod.
        private static void sifreEkle(Map<String, Map<String, String>> passwords,
                                      String hesapAdi, String kullaniciAdi, String sifre) {
